...
/**
 * Payload deserialization class [Handler] that extracts patient attributes and details from json payload
 * and use the values to construct an instance of org.openmrs.Patient instance. The payload used here
 * is obtained from QueueData.
 */
...
public class JsonRegistrationQueueDataHandler implements QueueDataHandler {
    ...
    public static final String DISCRIMINATOR_VALUE = "json-generic-registration";

    public static final DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

    public final Log log = LogFactory.getLog(JsonGenericRegistrationQueueDataHandler.class);

    public Patient unsavedPatient;
    public String payload;
    Set<PersonAttribute> personAttributes;
    public QueueProcessorException queueProcessorException;
    ...
    public void validateUnsavedPatient() {
    ...
    public void populateUnsavedPatientFromPayload() {
    ...
    public PatientIdentifier getAutogeneratedIdentifier(){
        MuzimaSettingService settingService = Context.getService(MuzimaSettingService.class);
    ...
    public PatientIdentifier createPatientIdentifier(JSONObject identifierObject) {
    ...
    public PatientIdentifier createPatientIdentifier(String identifierTypeUuid, String identifierTypeName, String identifierValue) {
    ...
    public void setIdentifierTypeLocation(final Set<PatientIdentifier> patientIdentifiers) {
    ...
    public void setPatientBirthDateEstimatedFromPayload() {
    ...
    public void registerUnsavedPatient() {
    ...
    public String getPatientUuidFromPayload() {
        return JsonUtils.readAsString(payload, "$['patient']['patient.uuid']");
    }

    public void setPatientAddressesFromPayload() {
    ...
    public PersonAddress getPatientAddressFromJsonObject(JSONObject addressJsonObject){
    ...
    public void setPersonAttributesFromPayload() {
    ...
    public Patient findSimilarSavedPatient() {
    ...
    public Object getElementFromJsonObject(JSONObject jsonObject, String key){
