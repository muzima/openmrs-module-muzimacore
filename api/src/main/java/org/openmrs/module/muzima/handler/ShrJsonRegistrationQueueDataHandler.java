...
public class ShrJsonRegistrationQueueDataHandler implements QueueDataHandler {

    private static final String TAG = ShrJsonRegistrationQueueDataHandler.class.getSimpleName();
    private static final String DISCRIMINATOR_VALUE = "json-shr-registration";

    private static final DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

    private final Log log = LogFactory.getLog(ShrJsonRegistrationQueueDataHandler.class);
    ...
    public void process(final QueueData queueData) throws QueueProcessorException {
        log.info("Processing shr registration data: " + queueData.getUuid());
