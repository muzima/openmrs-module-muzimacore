...
public class JsonShrEncounterQueueDataHandler implements QueueDataHandler {

    private static final String DISCRIMINATOR_VALUE = "json-encounter";

    private static final DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");

    private final Log log = LogFactory.getLog(JsonShrEncounterQueueDataHandler.class);
    ...
    public boolean validate(QueueData queueData) {
        try {
            ...
            log.info("Processing shr encounter data: " + queueData.getUuid());
    ...
    private void processPatient(final Encounter encounter, final Object patientObject) {
        ...
        if (candidatePatient == null) {
            queueProcessorException.addException(new Exception("Unable to uniquely identify patient for this shr encounter data. "));
