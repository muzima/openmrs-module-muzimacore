...
public class EnketoResultTest extends BaseModuleContextSensitiveTest {
	...
	public void getForm_shouldEmpty()
	        throws ParserConfigurationException, XPathExpressionException, SAXException, IOException, DocumentException {
	...
	@Test
	public void getForm_shouldGetForm()
	        throws ParserConfigurationException, XPathExpressionException, SAXException, IOException, DocumentException {
	...
	@Test
	public void getForm_shouldGetModel()
	        throws ParserConfigurationException, XPathExpressionException, SAXException, IOException, DocumentException {
		String result = "<root><model><x/><y/></model><form><ul><li/><li/></ul></form></root>";
		EnketoResult enketoResult = new EnketoResult(result);
		assertThat(enketoResult.getForm(), is("<form><ul><li/><li/></ul></form>"));
	...
	public void test() throws IOException, DocumentException, TransformerException, ParserConfigurationException {
		...
		EnketoXslTransformer enketoXslTransformer = new EnketoXslTransformer(transformerFactory,
		        XslTransformPipeline.xform2HTML5Pipeline());
		ModelXml2JsonTransformer modelXml2JsonTransformer = new ModelXml2JsonTransformer(transformerFactory,
		        XslTransformPipeline.modelXml2JsonXSLPipeline());
		ODK2JavarosaTransformer odk2JavarosaTransformer = new ODK2JavarosaTransformer(transformerFactory,
		        XslTransformPipeline.modelXml2JsonXSLPipeline());
		ODK2HTML5Transformer odk2HTML5Transformer = new ODK2HTML5Transformer(transformerFactory,
		        XslTransformPipeline.ODK2HTML5());
		MuzimaFormServiceImpl muzimaFormService = new MuzimaFormServiceImpl(muzimaFormDAO, enketoXslTransformer,
		        modelXml2JsonTransformer, odk2JavarosaTransformer, odk2HTML5Transformer, null);
