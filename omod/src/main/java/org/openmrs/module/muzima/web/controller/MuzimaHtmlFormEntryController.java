...
public class MuzimaHtmlFormEntryController {
    ...
    public Map<String, Object> convertHtmlForms(final @RequestParam(value = "id") Integer id) {
        ...
        if (Context.isAuthenticated()) {
			...
			HtmlFormEntryService htmlFormEntryService = Context.getService(HtmlFormEntryService.class);
			HtmlForm htmlForm = htmlFormEntryService.getHtmlFormByUuid("30572da9-46c5-47f1-8396-5b40738f59fe");
			...
			String inputXml = "<htmlform> <obs conceptId=\"5090\" labelText=\"Height\" />  <obs conceptId=\"5089\" /> </htmlform>";
